...
def register(request):
    if request.method == "POST":
        ...
        return HttpResponse("<h1 style='color:green'>Student enrolled successfully!!</h1>")
...
def course_search(request):
    if request.method =="POST":
        cid = request.POST.get("cname")
        s = Student.objects.all() # Create your views here.
        ...
        if len(student_list)==0:
            return HttpResponse("<h1 style='color:red'>No student enrolled</h1>") 
